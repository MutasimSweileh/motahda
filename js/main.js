! function(e) {
    ...
    function l() {
        ...
        (function() {
            ...
            a('[name="name"],[name="email"],[name="subject"],[name="message"]'), e(i).val() && e(i).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(i).removeClass("is-invalid"), s = !0) : (e(i).addClass("is-invalid"), s = !1);
            return s
        })() && jQuery.ajax({
            url: e(o).attr("action"),
            data: t,
    ...
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function() {
        ...
        e(this).each((function() {
            var a, n, o, i, r, l, d = e(this);
            a = d.attr(t), n = d.attr(s), o = d.data("margin-top"), i = d.data("margin-bottom"), r = c(e(n).css("padding-top")), l = c(e(n).css("padding-bottom")), "margin-top" === a ? (e(n).css("padding-bottom", l + c(o) + "px"), d.css("margin-top", "-" + c(o) + "px").css({
                position: "relative",
                "z-index": "3"
            })) : "margin-bottom" === a && (e(n).css("padding-top", r + c(i) + "px"), d.css("margin-bottom", "-" + c(i) + "px").css({
                position: "relative",
                "z-index": "3"
            }))
        }))
