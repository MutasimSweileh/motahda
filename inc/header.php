...
<head>
    ...
    <meta name="msapplication-TileImage" content="images/favicon.pn" />
...
<body>
    <div class="popup-search-box d-none d-lg-block">
        ...
        <form action="<?= $core->getPageUrl("projects" . $plang) ?>" method="POST">
            <input type="text" name="name" placeholder="<?= plang("عما تبحث", "What are you looking for") ?>" /> <button type="submit"><i class="fal fa-search"></i></button>
        </form>
    </div>
    ...
    <div class="as-menu-wrapper">
        <div class="as-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.html"><img src="images/logo.png" alt="Mechon" /></a>
            </div>
            <div class="as-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="#" title=""><?= plang("مركز الوسائط", "Media Center") ?></a>
                        <ul class="sub-menu">
            ...
            <div class="header-top">
                <div class="container">
                    <div class="row justify-content-center justify-content-md-between align-items-center">
                        <div class="col-auto">
                            <p class="header-notice d-none d-lg-block"><?= getValue('header_text', $lang) ?></p>
                        </div>
                        <div class="col-auto">
                            <div class="header-social">
                                <span class="social-title"><?= plang('تابعنا', 'Follow Us') ?></span>
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="logo-style2">
                                <a href="<?= $core->getPageUrl("index" . $plang) ?>"><img src="images/logo.png" alt="Mechon" /></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="header-button">
                                ...
                                <div class="ft-content">
                                    ...
                                    <span><?= plang('إرسال بريد إلكتروني', 'Make An Email') ?></span>
                                    <a href="mailto:<?= getValue('email') ?>" class=""><?= getValue('email') ?></a>
                                </div>
                ...
                <div class="menu-area">
                    <div class="container">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="d-flex align-items-center sawe"> <button type="button" class="icon-btn searchBoxToggler"><i class="fal fa-search"></i></button>
                                    <a href="<?= plang($core->getPageUrl("index"), $core->getPageUrl("indexarabic")) ?>" class="header-link-btn"><i class="fal fa-globe"></i><?= plang('English', 'Arabic') ?></a>
                                </div>
