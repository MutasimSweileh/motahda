          ...
          <div class="row">
            ...
            <div class="col-sm-6 pull-righta">
              <div class="form-group">
                <label><?= plang('الاسم', 'Name') ?></label>
                <input name="name" class="form-control" type="text" placeholder="<?= plang('الاسم', 'Name') ?>" required="required" value="">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label><?= plang('البريد الالكترونى', 'Email') ?></label>
                <input name="email" class="form-control required email" type="email" placeholder="<?= plang('البريد الالكترونى', 'Email') ?>" value="" required="required">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 col-lg-6">
              <div class="form-group">
                <label><?= plang('رقم الهاتف', 'Mobile') ?></label>
                <input name="mobile" class="form-control" type="text" placeholder="<?= plang('رقم الهاتف', 'Mobile') ?>" value="">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label><?= plang('المدينة', 'City') ?></label>
                <input name="city" class="form-control required " type="text" placeholder="<?= plang('المدينة', 'City') ?>" value="" required="required">
              </div>
            </div>
          </div>
...
">
    ...
    float: none;
    display: inline;" placeholder="<?= plang("اكتب كود التحقق", "Write Code") ?>" required="required" autocomplete="off">
          ...
          <div class="form-group" style="    text-align: center;">
            ...
            <button type="submit" name="btnSubmit" value="btnSubmit" class="btn btn-dark btn-theme-colored btn-flat mr-5" data-loading-text="من فضلك انتظر ..." id="btn" title="ارسال"><?= plang('ارسال', 'Send') ?></button>
